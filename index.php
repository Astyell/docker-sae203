...
<head>
	...
	<link rel="icon" href="img/POKE2.png" sizes="any" />
...
<body>
	...
	<?php
		...
		echo  $_SESSION['PKMN_Random']['PKMN_ID'], " - ", $_SESSION['PKMN_Random']['PKMN_Nom_FR'];

	?>

	<aside>
        <p>
			Vous avez effectué <?php echo $_SESSION ['NB_Essais'] ?> coup(s)
			<br />
			<div>
				<div class=box_100x20 style="background-color:rgb(64, 128, 73);" > Elément correcte </div> 
			<div class=box_100x20 style="background-color:rgb(168, 83, 83);" > Elément incorrecte </div> 
			</div> 
		</p>
    </aside>
